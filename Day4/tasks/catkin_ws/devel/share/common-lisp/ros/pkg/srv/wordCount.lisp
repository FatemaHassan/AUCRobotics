...
(cl:defmethod cl:initialize-instance :after ((m <wordCount-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'wordCount-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pkg-srv:<wordCount-request> is deprecated: use pkg-srv:wordCount-request instead.")))

(cl:ensure-generic-function 'words-val :lambda-list '(m))
(cl:defmethod words-val ((m <wordCount-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pkg-srv:words-val is deprecated.  Use pkg-srv:words instead.")
  (words m))
...
(cl:defmethod cl:initialize-instance :after ((m <wordCount-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'wordCount-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pkg-srv:<wordCount-response> is deprecated: use pkg-srv:wordCount-response instead.")))

(cl:ensure-generic-function 'count-val :lambda-list '(m))
(cl:defmethod count-val ((m <wordCount-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pkg-srv:count-val is deprecated.  Use pkg-srv:count instead.")
  (count m))
